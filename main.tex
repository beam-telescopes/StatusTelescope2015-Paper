...
Its width at the two centre pixel planes using all six planes for tracking in a 6\,GeV electron/positron-beam is measured to be $(2.88\,\pm\,0.01)\,\upmu\meter$.
...
The mean intrinsic resolution over the six sensors used is found to be $(3.25\,\pm\,0.03)\,\upmu\meter$.
With a 6\,GeV electron/positron beam, the pointing resolution halfway between the two inner pixel planes using an equidistant plane spacing of 20\,mm is estimated to $1.75\,\pm\,0.02\upmu\meter$
