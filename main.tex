...
\title{Track resolution studies with the \\ \vspace{1mm}
...
Its width at the two centre pixel planes using all six planes for tracking in a 6\,GeV electron/positron-beam is measured to be $(2.88\,\pm\,0.06)\,\upmu\meter$.
...
With a 6\,GeV electron/positron beam, the track resolution halfway between the two inner pixel planes using an equidistant plane spacing of 20\,mm is estimated to $1.75\,\pm\,0.02\upmu\meter$
...
The authors would like to thank Claus Kleinwort, Ulrich K\"otz and Jan Dreyling-Eschweiler for helpful discussions. 
