...
For both geometries, the result is consistent with earlier analyses that yielded intrinsic resolutions of $\sigmai \approx\,3.4\,\micro\meter$ and $\sigmai \approx\,3.5\,\micro\meter$~\cite{ref:thomas,ref:mimosa26}.
...
In the energy range covered, $\kappa$ is found to be constant at a value $\kappa = 0.864 \pm 0.005$, which translates to a correction of 14\,\% with respect to the Highland formula. 
...
With increasing threshold, the efficiency decreases down to $82\,\%$ at $\noise = 12$. 
