...
\begin{figure}[t]
  ...
  \includegraphics[width=0.49\textwidth]{figures/trackres_vs_epsdut_DESY} \put(-142,32){(A)}%\put(-155,40){(B)}
  \includegraphics[width=0.49\textwidth]{figures/trackres_vs_epsdut_SPS} \put(-142,32){(B)}%\put(-155,40){(B)}
