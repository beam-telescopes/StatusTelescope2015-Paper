Data was taken in $2012$ and $2013$ using the $\DESY$-type beam telescopes, cf.~section~3, which were operated with EUDAQ, cf.~section~4. 
...
For $\dz = \dzdut = 20\,\milli\meter$ at 5\,GeV beam energy the pointing resolution on the DUT is about $1.9\,\upmu\meter$ for $\epsdut = 0.001$. 
For SPS energies, a pointing resolution of $1.4\,\upmu\meter$ is predicted. 
