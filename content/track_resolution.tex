...
The material thicknesses and the amount of multiple scattering therein are only known with a certain accuracy affecting the predicted residual width and the track resolution
 and thereby the derived intrinsic resolution. 
...
\begin{table}[tbp]
 \begin{center}
  ...
  $\sigma_{\sigmai}$ in \% & × & $E\pm5\,\%$ & $\Theta\pm10\,\%$ & fit range & $\sum$\\ \hline
  biased   &  20 mm & 0.3 & 1.1  & 0.3 & 1.7 \\
  ×        & 150 mm & 0.10 & 0.13 & 0.05 & 0.28\\
  unbiased &  20 mm &   3 & 6    & 4  & 13\\
  ×        & 150 mm & n/a & n/a  & n/a & \\
  %× & × & × & ×
  \end{tabular}
...
If $\kappa$ is significantly different from one is to be determined with data. 
