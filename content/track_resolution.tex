...
\begin{figure}[btp]
  \centering
  \includegraphics[width=0.49\textwidth]{figures/res_vs_z_20}  \put(-50,40){(A)} % was thin_smiley.pdf
  \includegraphics[width=0.49\textwidth]{figures/res_vs_z_150} \put(-50,40){(B)} % was wide_smiley.pdf
