...
After all steps have been applied on a run, the unbiased residuals for this run should have been successfully calculated. {comment hj: datura-noDUT is jargon}\\
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.49\textwidth]{figures/thin_smiley.pdf}
  \includegraphics[width=0.49\textwidth]{figures/wide_smiley.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.49\textwidth]{figures/resi_thresh_errors}	\put(-175,100){(A)}
