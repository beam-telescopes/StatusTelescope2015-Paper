...
\begin{table}[tbp]
 \begin{center}
  ...
  2\,GeV & 20 mm   &  biased  &  ${}^{-1.56}_{+1.13}$ & ${}^{+0.65}_{-1.22}$ & ${}^{+0.23}_{+0.33}$ & 3.1 &  3.7  \\
	 ...
	 & 150 mm  &  biased  &  ${}^{-10.5}_{+15.7}$ & ${}^{+10.2}_{-6.59}$ & ${}^{+8.0}_{+0.8}$ & 0.82 &  20.3 \\
...
The root mean square of the width of the pull distributions is therefore included in the table. %over all planes is 1.8\,\% and 1.7\,\% for the narrow and the wide geometry, respectively, for biased track fits using beam particles with 6\,GeV. 
