...
\begin{table}[tbp]
 \begin{center}
  ...
  \multicolumn{2}{c|}{} & \multicolumn{5}{c}{$\sigma_{\sigmai}$ in \%}\\
  \multicolumn{2}{c|}{} & \multicolumn{3}{c|}{per plane} & all planes& $\sqrt{\sum x_i^2}$\\
  \multicolumn{2}{c|}{} &$E\pm5\,\%$ & $\Theta\pm1\,\%$ & fit range & rms &  \\ \hline
  biased   &  20 mm &   &  &  &  &    \\
  ×        & 150 mm &   &  &  &  &    \\
  unbiased &  20 mm &   &  &  &  &    \\
  ×        & 150 mm &   &  &  &  &    \\
