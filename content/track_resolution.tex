...
\begin{table}[tbp]
 \begin{center}
  ...
  \multicolumn{3}{c|}{} & \multicolumn{3}{c|}{per plane} & all planes& $\sqrt{\sum (\max(x_i))^2}$\\
  \multicolumn{3}{c|}{} &$E\pm5\,\%$ & $\Theta\pm X\,\%$ & fit range    & rms &  \\ 
  \multicolumn{3}{c|}{} & &                              & $\pm 1\,$std.&               &  \\ \hline
  6\,GeV & 20 mm   &  biased  &  ${}^{-0.34}_{+0.21}$ &  & ${}^{+1.76}_{-1.27}$ &  &    \\
         & ×       & unbiased &  ${}^{}_{}$ &  &  &  &    \\
	 & 150 mm  &  biased  &  ${}^{-3.5}_{+2.9}$ &  & ${}^{+6.4}_{-5.4}$ &  &    \\
	 & ×       & unbiased &  ${}^{}_{}$ &  &  &  &    \\ \hline
  2\,GeV & 20 mm   &  biased  &  ${}^{-1.56}_{+1.13}$ &  & ${}^{+0.23}_{+0.33}$ &  &    \\
         & ×       & unbiased &  ${}^{}_{}$ &  &  &  &    \\
	 & 150 mm  &  biased  &  ${}^{-10.5}_{+15.7}$ &  & ${}^{+8.0}_{+0.83}$ &  &    \\
	 & ×       & unbiased &  ${}^{}_{}$ &  &  &  &    \\ 
  %× & × & × & ×
  \end{tabular}
