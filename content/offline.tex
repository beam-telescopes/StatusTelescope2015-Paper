...
EUTelescope comes with its own job submission framework Jobsub that allows for submission of analysis jobs on local machines or on larger batch computing clusters such as the NAF\footnote{National Analysis Facility. This is a German UNIX cluster.} or LXPLUS\footnote{LXPLUS is a CERN UNIX cluster} for bulk reconstruction.
